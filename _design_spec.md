...
| Delivery Context | 主要用于约 15–20 分钟、有主讲人的中文课题组现场汇报；次要用于会后独立浏览和新人上手 |
...
#### Slide 06 - 在 VS Code 中使用 Codex：安装、给上下文、审查变更
...
#### Slide 07 - Git 不是“网盘”：它是每个人都拥有完整历史的版本系统
...
#### Slide 10 - 科研使用 Git：版本应回答“这次实验为什么不同”
...
#### Slide 11 - Codex 负责执行，Git 负责建立可信检查点
...
- **Motion suggestion**: 从 Slide 10 的分支主线延续为闭环中的 Git 检查点，作为 Morph candidate；自定义动画保持关闭。

#### Slide 12 - 三条规则，把 AI 辅助编程变成可复现科研
